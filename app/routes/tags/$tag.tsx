...
import { filterPostsByTitle, getPostsSortedByDate } from "~/utils/posts.server";
...
export const meta: MetaFunction = ({ params }) => {
  const { tag } = params;
  const title = `${tag} - ${siteMetadata.client}`;
  const summary = `Posts about ${tag} of ${siteMetadata.client}.`;
